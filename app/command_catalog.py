...
_ENTRIES: list[tuple[str, dict[str, Any]]] = [
    ...
    _cmd("unpin_reply", "Открепить сообщение", "открепить", "Открепить сообщение, на которое ответил администратор", "unlock", aliases=("unpin", "открепить сообщение"), category="Управление группой", special="unpin_reply", target=False, response="Сообщение откреплено."),
    _cmd("unpin_all", "Открепить всё", "открепить всё", "Снять все закреплённые сообщения в беседе", "unlock", aliases=("открепить все", "unpin all", "unpinall", "снять все закрепы"), category="Управление группой", special="unpin_all", target=False, response="Все сообщения откреплены."),
    _cmd("chat_link_one", "Ссылка на чат для одного пользователя", "ссылка на чат 1", "Создать отдельную ссылку, которой сможет воспользоваться один пользователь", "lock", aliases=("одноразовая ссылка на чат", "ссылка на чат одному", "chat link 1"), category="Управление группой", special="chat_link_one", target=False, response="Одноразовая ссылка создана."),
    _cmd("chat_link", "Ссылка на чат", "ссылка на чат", "Выдать актуальную основную ссылку на беседу", "lock", aliases=("ссылка чата", "chat link"), category="Управление группой", special="chat_link", target=False, response="Ссылка на чат получена."),
